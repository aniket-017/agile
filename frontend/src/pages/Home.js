  ...
  const serviceProviders = [
    {
      id: 1,
      name: "Uniphore",
      description: "Contact center AI solutions",
    ...
    },
    {
      id: 3,
      name: "Base64.ai",
      description: "Document AI solutions",
    ...
    },
    {
      id: 4,
      name: "Snapcheck",
      description: "AI powered background solutions",
    ...
    <div>
      ...
      <section>
        <div className="hero-section">
          ...
          <div className="hero-text">
            <h1>Start your Genrative AI journey with us</h1>
            <p>Transforming ideas into reality with every breakthrough in AI technology.</p>
          </div>
        </div>
      </section>
      {/* Most Visited Categories Section */}
      <section className="most-visited-categories">
        <Container className="services-cat">
          <h1>AI Services</h1>
          <p>
            Our partners offer wide range of AI solutions and services for your business needs along with the cost-effective
            infrastructure.
          </p>
          <Row>
      ...
      <div className="full-width-container">
        <img
          src="http://amentotech.com/htmls/servosell/images/index/community/banner.jpg"
          alt="Banner"
          className="w-100"
        />
        <div className="banner-content">
          <h2>Want to become our partner?</h2>
          <p>Join us and take advantage of our advanced AI solutions</p>
          <div className="button-group">
            <Button variant="primary" onClick={register} className="banner-button">
              Register
            </Button>
            <Button variant="secondary" onClick={requestService} className="banner-button">
              Request Service
            </Button>
          </div>
        </div>
              ...
              <Col key={provider.id} md={3} className="mb-4">
                <Card className="provider-card">
                  ...
                  <Card.Body>
                    ...
                    <Button variant="primary" href={provider.link} target="_blank" rel="noopener noreferrer">
                      Visit Website
                    </Button>
                  </Card.Body>
                </Card>
      ...
      <footer className="footer">
        <Container>
          <p>© 2024 Agilelabs Company. All rights reserved.</p>
        </Container>
      </footer>
    </div>
  );
